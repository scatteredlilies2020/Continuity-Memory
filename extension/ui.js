...
import { buildMemoryPrompt } from './retrieval.js?v=0.14.0-standalone.143';
...
import { alignWorldToChat, collectFingerprintMessages, collectMemoryEligibleMessages } from './message-digest.js?v=0.14.0-standalone.143';
import { resolveMissingWorldBinding } from './chat-ownership.js?v=0.14.0-standalone.143';
import { runtime, onRuntimeChange, pauseRuntime, resumeRuntime, stopRuntime, updateRuntime } from './runtime.js?v=0.14.0-standalone.143';
import { completeL1MessageCount, resolveL1GroupSize, validateL1GroupSize } from './l1-policy.js';
import { resolveInjectionBudget } from './injection-budget.js';
import { bindCurrentChat, getBoundWorldId, getChatKey, getSettings, markWorldDeleted, resetConfigurationSettings, resetPromptSettings, saveSettings } from './settings.js?v=0.14.0-standalone.143';
import { embeddingProviderDescription, pauseEmbeddingIndexing, purgeEmbeddingIndex, rebuildEmbeddingIndex, resumeEmbeddingIndexing, scheduleEmbeddingIndexSync, stopEmbeddingIndexing } from './embedding-retrieval.js?v=0.14.0-standalone.143';
import { embeddingModelChoices, resolveEmbeddingProvider } from './embedding-provider.js?v=0.14.0-standalone.143';
...
import { forkWorldToBranch } from './branch-cache.js?v=0.14.0-standalone.143';
import { clampReviewFontSize, DEFAULT_REVIEW_FONT_SIZE, extractionReviewRecoveryAction, pinchedReviewFontSize, REVIEW_FONT_STEP, touchDistance } from './review-display.js?v=0.14.0-standalone.143';
import { retrievalSnapshotDiagnostics } from './retrieval-snapshot.js?v=0.14.0-standalone.143';
...
async function restartBuild() {
    ...
    if (!window.confirm(`Rebuild extracted memory from the beginning for all ${messageCount} chat messages? This immediately and permanently erases extracted structured memory, L1/L2/L3, extraction records, retrieval cache, and vectors, while preserving reviewed user corrections and their corrected records as authoritative guardrails. Every fresh L1 chunk calls the model and is saved as it completes, so Build can resume missing ranges after a failure. No backup is saved.`)) return { cancelled: true };
