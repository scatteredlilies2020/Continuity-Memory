...
import { api } from './api.js?v=0.14.0-standalone.38';
...
import { expandRetrievalTerms } from './semantic-retrieval.js?v=0.14.0-standalone.38';
...
import { ensureCurrentChatMemory, initUI, refreshModelProfiles, renderRuntime, refreshWorlds } from './ui.js?v=0.14.0-standalone.38';
...
import { resolveDeletedChatBinding, resolveRenamedChatBinding } from './chat-ownership.js?v=0.14.0-standalone.38';
import { collectFingerprintMessages } from './fingerprint.js';
import { purgeEmbeddingIndex, queryEmbeddingMemory, resumeEmbeddingIndexing, scheduleEmbeddingIndexSync } from './embedding-retrieval.js?v=0.14.0-standalone.38';
