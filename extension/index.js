...
import { api } from './api.js?v=0.14.0-standalone.45';
...
import { expandRetrievalTerms } from './semantic-retrieval.js?v=0.14.0-standalone.45';
...
import { ensureCurrentChatMemory, initUI, refreshModelProfiles, renderRuntime, refreshWorlds } from './ui.js?v=0.14.0-standalone.45';
...
import { resolveDeletedChatBinding, resolveRenamedChatBinding } from './chat-ownership.js?v=0.14.0-standalone.45';
import { collectFingerprintMessages, findInvalidExtractionRanges } from './fingerprint.js';
import { purgeEmbeddingIndex, queryEmbeddingMemory, resumeEmbeddingIndexing, scheduleEmbeddingIndexSync } from './embedding-retrieval.js?v=0.14.0-standalone.45';
