...
export const ROLLING_STORY_RULE = `storySoFar is a separate retrospective rolling causal digest, not a memory record. Rewrite the complete digest from the supplied prior story plus the new raw excerpt only; globally re-rank both sources instead of appending a recap of the latest excerpt. Make it as short as possible without losing load-bearing continuity; the token allowance is a ceiling, never a target, and a much shorter complete digest is preferred. Importance comes from causal dependency and durable effect, never recency, position, length, drama, prose intensity, or how many messages a scene receives. Begin with the earliest foundational premise, origin, or initiating cause needed to understand the story, then preserve strict causal chronology; never crowd the opening out with later detail. Preserve older foundational premises, origins, irreversible transformations, identity or role changes, central commitments, and causes needed to understand later events until the supplied material supersedes them. New material earns space only when it establishes, changes, explains, complicates, resolves, or creates a consequential identity, role, relationship, motive, conflict, commitment, constraint, knowledge boundary, consequence, or unresolved matter. A calm scene may matter; routine conversation, affection, travel, rest, logistics, repeated sentiment, and uneventful interaction do not merit inclusion unless they cause such a change. When space is tight, remove recent low-consequence material before older load-bearing continuity. Use dense telegraphic prose, compact fragments, and semicolon-linked clauses. Omit headings, bullets, formatting, atmosphere, scene-setting, dialogue retelling, transitions, repetition, literary phrasing, and details that do not affect later understanding. Do not inventory supporting cast, equipment specifications, numeric strength, route or zone codes, minor names, or action-by-action combat choreography unless a later causal development depends on that exact information. Prefer broad causal developments over objects, locations, injuries, intermediate actions, and other specifics. Retain an exact detail only when later understanding depends on it; compress wording, never causal meaning. Preserve causal order from the beginning through the end of the excerpt, including major decisions, changes, consequences, and unresolved matters. Record only what has already occurred in the supplied material. Never call a condition current, present, latest, or ongoing, and never use currently, now, at present, or similar framing. Do not predict or narrate future events. Report a plan, intention, promise, expectation, or unresolved goal only as expressed or unresolved, never as completed. Attribute beliefs, reports, deception, and uncertainty to their holders or sources. Use explicit names wherever omission would create ambiguity. Do not consult, copy, cite, or name L1, L2, L3, retrieved records, hierarchy levels, memory categories, or internal IDs. If there is no prior story, begin from the raw excerpt.`;
