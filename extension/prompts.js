...
export const EPISTEMIC_MEMORY_RULES = `Keep objective canon separate from subjective perspective. Dialogue, accusation, rumor, inference, deception, and private conclusions are not canon by repetition or confidence. Store a durable subjective claim inside facts as a fact about its holder: subject is the holder, category is "character belief", predicate is "belief about CANONICAL_SUBJECT — PROPOSITION_TYPE", and value states what that holder believes plus any explicit confidence. Preserve conflicting holders separately. Canon remains unknown when no objective fact or event establishes it. A later reveal creates a separate canonical record; update the attributed belief only when its holder learns or changes their mind. Scene capsules and summaries must preserve attribution.`;
...
Preserve who believed, reported, suspected, or knew each uncertain claim. Never turn an unresolved or subjective claim into objective canon.
