...
export const CHARACTER_PROFILE_RULE = `Fill characterProfile fields roleBackground, appearance, personalityQuirks from grammar about that person; never invent or take another's role, body, thought, reaction, pronoun, comparison, or status panel; empty if unknown/non-person.`;
