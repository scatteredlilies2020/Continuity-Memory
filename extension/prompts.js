...
Use state for replaceable values or conditions that are true at the end of the excerpt. Use facts for stable or cumulative knowledge; when one predicate has several simultaneous values, combine the complete set into one value instead of emitting competing records. Use events for notable things that happened. Use relationships for meaningful connections or dependencies between any actors or subjects. Use threads for unresolved intentions, questions, commitments, processes, tensions, risks, or goals. Reuse stable names and wording for recurring actors, attributes, relationships, and threads. Do not invent facts. Avoid duplicating the same idea in many fields.
${IMPORTANCE_RUBRIC}
