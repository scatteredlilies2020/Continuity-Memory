...
export const CHARACTER_PROFILE_RULE = `Fill characterProfile fields roleBackground, appearance, personalityQuirks from narrative or accepted memory; never invent or use status panels or another person's fields; empty if unknown/non-person. Descriptions empty; validation builds them.`;
