...
Every entry must pass this counterfactual test: removing it would make a later identity, role, relationship, motive, conflict, commitment, rule, knowledge boundary, consequence, or unresolved matter materially harder to understand. Otherwise omit it. Preserve overarching ambitions, hidden capabilities, identity secrets, asymmetric knowledge, concealed relationships, and premise-defining resources when they remain necessary to understand the world, even if they have not appeared recently. Collapse action into result: who changed what, its durable consequence, and why it matters. Generalize or omit exact counts, percentages, durations, colors, materials, measurements, minor actors, staff rosters, vehicles, unit names, equipment specifications, route or zone codes, games, routine reassurance, temporary injuries or treatment, and combat techniques. Preserve an exact name, value, object, deadline, or rule only when exactness itself drives later causality. Never inventory possessions or repeat one fact across sections.
