...
export const CHARACTER_PROFILE_RULE = `For recurring people, fill characterProfile fields roleBackground, appearance, personalityQuirks; empty if unknown/non-person. Use established source wording only; never invent; retain details. Leave people descriptions empty; validation builds them.`;
