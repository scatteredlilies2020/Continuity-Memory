...
export const EPISTEMIC_MEMORY_RULES = `Keep objective canon separate from subjective perspective. Facts and events require narration, direct observation, simulation state, or an explicit authoritative correction that establishes them as true; dialogue, accusation, rumor, inference, deception, and a character's private conclusion do not become canon by repetition or confidence.
