...
import { compactPromptProvenance } from './prompt-provenance.js?v=0.15.0-testing.22';
...
import { DEFAULT_INJECTION_INSTRUCTION } from './prompts.js?v=0.15.0-testing.22';
import { embeddingRecordKey } from './embedding-index.js?v=0.15.0-testing.22';
