...
import { compactPromptProvenance } from './prompt-provenance.js?v=0.15.0-testing.21';
...
import { DEFAULT_INJECTION_INSTRUCTION } from './prompts.js?v=0.15.0-testing.21';
import { embeddingRecordKey } from './embedding-index.js?v=0.15.0-testing.21';
