...
import { upgradeOocMetaAuthorityPrompt } from './prompts.js?v=0.15.0-testing.19';
...
import { applyReviewBeforeCommitDefault, DEFAULT_REVIEW_BEFORE_COMMIT } from './review-policy.js?v=0.15.0-testing.19';
import { retainLatestPromptRule } from './prompt-migration.js?v=0.15.0-testing.19';
