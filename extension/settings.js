...
import { applyReviewBeforeCommitDefault, DEFAULT_REVIEW_BEFORE_COMMIT } from './review-policy.js?v=0.14.0-standalone.299';
import { retainLatestPromptRule } from './prompt-migration.js?v=0.14.0-standalone.299';
...
export function getSettings() {
    ...
    if (Number(settings.oocMetaAuthorityPromptVersion || 0) < 2) {
