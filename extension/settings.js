...
import { applyReviewBeforeCommitDefault, DEFAULT_REVIEW_BEFORE_COMMIT } from './review-policy.js?v=0.14.0-standalone.248';
import { retainLatestPromptRule } from './prompt-migration.js?v=0.14.0-standalone.248';
