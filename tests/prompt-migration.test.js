...
test('Digest identity-boundary migration replaces the previous rule without duplication', () => {
    ...
    assert.equal(compacted.split(DIGEST_EPISTEMIC_COVERAGE_RULE).length - 1, 1);
